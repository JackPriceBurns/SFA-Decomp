...
/* Auto-stubbed for compileability: unsupported body pseudo-types, invalid Ghidra slice syntax, undeclared wide temporaries need manual cleanup. */
/* Original raw Ghidra body omitted for compile-first stubbing. */
