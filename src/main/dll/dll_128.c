 ...
 *   dll_128.c -> waterfallControl.c -> backpack.c -> dll_F5.c ->
 *   dll_12B.c -> landedArwing.c
 * - debug-side path: dll/dll_128.c
 *
 * Why this stub exists:
 * - dll_128.c is a concrete anonymous bridge target in a stable debug-side
 *   neighborhood leading into the backpack/landedArwing packet.
