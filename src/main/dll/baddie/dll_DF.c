...
/* Auto-stubbed for compileability: unsupported helper macros: SUB41, pointer-heavy local typing needs manual cleanup, forced full-owner stub for compile-first import. */
